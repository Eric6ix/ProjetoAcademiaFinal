...
function Cadastro() {
  ...
  return (
    ...
    <div className="max-w-md mx-auto mt-10 bg-white p-8 border border-zinc-300 rounded-lg shadow-lg">
      ...
      <h2 className="text-2x1 font-bold mb-6 text-center text-gray-800">Cadastro</h2>
      ...
      <form onSubmit={handleSubmit}>
        ...
        <button className="w-full bg-blue-500 text-white py-2 rounded-md hover:bg-blue-400">Cadastrar-se</button>
      </form>
